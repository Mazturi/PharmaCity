...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/patient/'), array(0 => 'ROLE_USER'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/doctor/'), array(0 => 'ROLE_DOCTOR'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/pharmacy/'), array(0 => 'ROLE_PHARMACY'), NULL);
